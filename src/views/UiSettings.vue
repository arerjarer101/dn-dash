...
<template>
  ...
  <template v-if="!simple">
    <div class="grid grid-radio">
      <div class="col-2"><h5>Menu Type</h5></div>
  ...
  <template v-if="!simple">
    ...
    <div class="grid grid-radio">
      <div class="col-2"><h5>Input Style</h5></div>
      
      <div class="field-radiobutton col-2">
        <RadioButton name="inputStyle" value="outlined" v-model="layoutConfig.inputStyle.value" inputId="outlined_input">
        </RadioButton>
    ...
    <div class="grid">
      <div class="col-2"><h5>Ripple Effect</h5></div>
      <div class="col-2"><InputSwitch v-model="layoutConfig.ripple.value"></InputSwitch></div>
    </div>
  ...
  <div class="grid">
    <div class="col-2"><h5>Fluent UI</h5></div>
    <div class="col-2">
  ...
  <div class="grid">
    <div class="col-2"><h5>PrimeOne Design - 2022</h5></div>
    <div class="col-2">
  ...
  <div class="grid">
    <div class="col-2"><h5>PrimeOne Design - 2021</h5></div>
    <div class="col-2">
...
.grid-radio div:not(:first-of-type) {
  max-width: 12rem
}
